...
def main():
    ...
    st.markdown("---")
    st.markdown("### About ###")
    st.info("This application allows you to import CSV files of temple workers exported into a database, manage the data with full Create, Read, Update and Delete capabilities, and customize the schema by renaming or adding fields. You can also overwrite the whole collection using a new csv file. Reports can be sorted by all fields using the buttons above the columns.")
